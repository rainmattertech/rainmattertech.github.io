...
SITE = {
	...
	# Site description
	'description': 'Official Rainmatter engineering blog',
	...
	'github_repo': 'https://github.com/rainmattertech/rainmattertech.github.io.git',
